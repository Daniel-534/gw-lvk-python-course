...
La relatividad especial de Einstein (1905) constituye el fundamento conceptual de toda la física moderna. Su logro central fue demostrar que el espacio y el tiempo no son entidades absolutas e independientes, sino que forman una unidad geométrica denominada \textbf{espacio-tiempo de Minkowski}, cuya estructura se revela bajo las transformaciones de Lorentz. El dominio de esta teoría es imprescindible antes de abordar la relatividad general: las ecuaciones de campo de Einstein reproducen la física de Minkowski en el límite de campo gravitacional débil, y cualquier punto del espacio-tiempo curvo admite un sistema de referencia localmente inercial equivalente al espacio de Minkowski \cite{Carroll2004, Schutz2009, Misner1973, Einstein1905}.
