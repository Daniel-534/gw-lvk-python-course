...
\begin{definicion}{Tensión en crecimiento ($\sigma_8$/$S_8$)}{def_tension_s8}
...
En un modelo plano con $w=-1$, use $\rho_m\propto a^{-3}$ y $\rho_\Lambda=\text{cte}$ para obtener una expresión de $z_{\rm eq,m\Lambda}$ en función de $\Omega_m$ y $\Omega_\Lambda$.
