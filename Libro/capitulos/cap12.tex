...
Resolver simultáneamente horizonte y planitud suele requerir $N\gtrsim 50$--$60$, dependiendo del modelo y del reheating.
...
% ===========================================================
\section{Fin de inflación, reheating y conexión con el Big Bang caliente}
\label{sec:reheating}
% ===========================================================
...
\begin{definicion}{Reheating}{def_reheating}
El \textbf{reheating} es la etapa de conversión de la energía del inflatón en un plasma térmico que inicia la fase del Big Bang caliente convencional.
\end{definicion}
...
\begin{align}
  ...
  r &< \mathcal{O}(10^{-1}) \text{ (límite superior, dependiente de combinación de datos)}.
\end{align}
