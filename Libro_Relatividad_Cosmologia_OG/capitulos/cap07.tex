...
\begin{enumerate}[leftmargin=2em, label=(\alph*)]
  ...
  \item La singularidad en $r = 0$ es una \textbf{singularidad física} (o curvatura): $K \to \infty$ cuando $r \to 0$. No puede eliminarse mediante ningún cambio de coordenadas y representa una genuine pathología del espacio-tiempo clásico.
\end{enumerate}
\end{proposicion}
...
\begin{enumerate}[leftmargin=2em, label=\textbf{P\thechapter.\arabic*.}]
  ...
  \begin{enumerate}[label=(\alph*)]
    ...
    \item Muestre que el resultado implica una precesión por vuelta $\Delta\varphi = 6\pi GM/(c^2 a(1-e^2))$ y calcula el valor en segundos de arco por siglo para Venus ($a = 1{,}082\times10^{11}\,\si{m}$, $e = 0{,}0068$) y Marte ($a = 2{,}279\times10^{11}\,\si{m}$, $e = 0{,}093$).
  \end{enumerate}

  \item \textbf{Deflexión de la luz.}
  \begin{enumerate}[label=(\alph*)]
    \item Para un fotón radial en el plano ecuatorial de Schwarzschild, escribe la ecuación de la trayectoria $u(\varphi)$ y muéstra que al orden más bajo en $r_s/b$ el ángulo de deflexión es $\delta\theta = 4GM/(c^2 b)$.
    ...
    \item Calcula el ángulo de deflexión de la luz para el agujero negro M87 ($M = 6{,}5\times10^9\,M_\odot$) observado a una distancia de $\sim 16$ Mpc. Compare con la resolución angular del EHT ($\sim 25\,\si{\mu as}$).
  \end{enumerate}
